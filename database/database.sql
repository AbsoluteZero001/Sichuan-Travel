...
INSERT INTO spots (name, city, season, price, open_time, image, images, description, guide, tips, rating, visit_count) VALUES 
('泸定桥', '甘孜藏族自治州', '夏季', 10.00, '08:00-18:00', '/images/luding-qiao.jpg', '["/images/luding-qiao.jpg"]', '泸定桥位于四川省甘孜藏族自治州泸定县，横跨大渡河，是中国工农红军长征中的著名历史桥梁，铁索桥与两岸风光气势雄浑。', '交通：成都经雅康高速至泸定约3小时；也可乘动车至泸定站后转乘公交或出租车。', '桥面摇晃，请按指示分批通行；可与海螺沟、二郎山串联游览。', 4.7, 52000);
